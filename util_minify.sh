...
cat media/js/public/min/design.min.js media/js/public/min/api.min.js > media/js/public/min/design.js
rm media/js/public/min/design.min.js media/js/public/min/api.min.js
mv media/js/public/min/design.js media/js/public/min/design.min.js
