...
if IS_MAINTENANCE:
    ...
    urlpatterns = [
        ...
        url(r'^code/?$', RedirectView.as_view(url='/download/', permanent=True)),
        url(r'^source/?$', RedirectView.as_view(url='/download/', permanent=True)),
        url(r'^repository/?$', RedirectView.as_view(url='/download/', permanent=True)),
        url(r'^documentation/?$', RedirectView.as_view(url='/docs/', permanent=True)),
        url(r'^reference/?$', RedirectView.as_view(url='/docs/', permanent=True)),
        url(r'^manual/?$', RedirectView.as_view(url='/docs/', permanent=True)),
